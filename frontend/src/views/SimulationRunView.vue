...
// Fetch maxRounds directly from query params at initialization so child components get the value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, skip full-screen loading on auto-refresh to avoid flicker
...
onMounted(() => {
  ...
  // Log maxRounds config (value already fetched from query params at initialization)
  if (maxRounds.value) {
